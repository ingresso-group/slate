...
`cached_max_seats_is_real` | A 'yes' / 'no' string indicating whether the data in the previous variable is actually real or not. Can be used whilst migrating away from using it.
